...
<section class="member-introduce">
  ...
  <div class="btn__wrap btn__wrap--member-page">
    <a href="<?php echo home_url('register'); ?>" class="btn block">オフィシャルメンバーの応募はこちら</a>
  </div>
  <div class="member-introduce__linkTextWrap">
    <a href="<?php echo home_url('contact'); ?>" class="member-introduce__linkText">釣り美女・オフィシャルメンバーへのお仕事依頼はこちら</a>
  </div>
